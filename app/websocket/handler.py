...
def _build_tts_action(emotion: str | None) -> dict | None:
    ...
    if normalized in {"happy", "excited", "laughing", "loving"}:
        return {
            "type": "sequence",
            "steps": [
                {"hand": 3, "angle": 50, "speed": 180, "hold": 150, "delay_after": 50},
                {"hand": 3, "angle": 90, "speed": 180, "hold": 250, "delay_after": 50},

                # Vẫy phải
                {"hand": 2, "angle": 115, "speed": 220, "hold": 200, "delay_after": 30},
                {"hand": 2, "angle": 85, "speed": 220, "hold": 150, "delay_after": 30},
                {"hand": 2, "angle": 115, "speed": 220, "hold": 200, "delay_after": 50},

                # Vẫy trái
                {"hand": 1, "angle": 115, "speed": 220, "hold": 200, "delay_after": 30},
                {"hand": 1, "angle": 85, "speed": 220, "hold": 150, "delay_after": 30},
                {"hand": 1, "angle": 115, "speed": 220, "hold": 200, "delay_after": 50},

                {"hand": 3, "angle": 90, "speed": 180, "hold": 500, "delay_after": 50},
                {"hand": 3, "angle": 40, "speed": 180, "hold": 100, "delay_after": 30},
    ...
    if normalized in {"sad", "sleepy"}:
        return {
            "type": "sequence",
            "steps": [
                {"hand": 3, "angle": 10, "speed": 120, "hold": 400, "delay_after": 50},
    ...
    if normalized == "confused":
        return {
            "type": "sequence",
            "steps": [
                {"hand": 1, "angle": 85, "speed": 180, "hold": 500, "delay_after": 50},
                {"hand": 1, "angle": 70, "speed": 150, "hold": 300, "delay_after": 30},
                {"hand": 1, "angle": 85, "speed": 150, "hold": 300, "delay_after": 30},
                {"hand": 1, "angle": 70, "speed": 150, "hold": 300, "delay_after": 30},
